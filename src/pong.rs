...
impl<'w> Pong<'w> {
    pub fn new(window : &Window) -> Pong {
        Pong{w: window, my: 0.0, mx: 0.0, score1: 0, score2: 0, hits: 0, ball: Default::default(), dx: 0.0, dy: 0.0, paddle1: Default::default(), paddle2: Default::default(),  paddle1dy: 0.0, paddle2dy: 0.0 /*  */}
    }
